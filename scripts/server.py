...
if __name__ == '__main__':
    ...
    print("-" * 65)
    print("📱 UNTUK HP / LAPTOP ALDEINA (WI-FI DA VINCI):")
    print(f"👉 Buka di Browser HP   : http://{local_ip}:{PORT}/admin.html")
    print("-" * 65)
    print("💻 UNTUK 4 LAPTOP POS MEJA TENGAH (WI-FI DA VINCI):")
    print(f"👉 Pos 1 (Scratch)      : http://{local_ip}:{PORT}/pos.html?pos=1")
    print(f"👉 Pos 2 (Mathchamps)   : http://{local_ip}:{PORT}/pos.html?pos=2")
    print(f"👉 Pos 3 (Memory)       : http://{local_ip}:{PORT}/pos.html?pos=3")
